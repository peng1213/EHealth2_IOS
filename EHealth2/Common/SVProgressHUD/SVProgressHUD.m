...
- (void)showText:(NSString *)string duration:(NSTimeInterval)duration;
- (void)dismiss;
...
{
    NSTimeInterval displayInterval = [[SVProgressHUD sharedView] displayDurationForString:text];
    [[self sharedView]showText:text duration:displayInterval];
}
