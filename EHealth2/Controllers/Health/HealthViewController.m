...
#import "CommonUtil.h"
@interface HealthViewController ()<GMGridViewDataSource, GMGridViewSortingDelegate, GMGridViewTransformationDelegate, GMGridViewActionDelegate>
{
...
-(void)loadView
{
    ...
    healthFuncs=[[NSMutableArray alloc]init];
    ...
    for (int i=0; i<[funList count]; i++) {
        ...
        if([funcs.FUNC_TYPE isEqualToString:@"健康"])
        {
            [healthFuncs addObject:funcs];
        }
    }
...
- (GMGridViewCell *)GMGridView:(GMGridView *)gridView cellForItemAtIndex:(NSInteger)index
{
    ...
    TFunctionInfo *func= (TFunctionInfo *)[healthFuncs objectAtIndex:index];
...
{
    TFunctionInfo *func=[healthFuncs objectAtIndex:position];
